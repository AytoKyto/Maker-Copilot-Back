 ...
 */
final class Version20240712172328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD urssaf_pourcent INT DEFAULT NULL, ADD urssaf_type INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP urssaf_pourcent, DROP urssaf_type');
    }
}
